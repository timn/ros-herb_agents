...
fsm:define_states{ export_to=_M,
  ...
  {"HANDOFF_TO_HUMAN",Skill, skills={{"say", text="I am going to give you this."},{"go_to_tm", side="right"}}, 
...
fsm:add_transitions{
  {"START", "GO_INITIAL_LEFT", "op.objects_on_table and (not HERB_holding_object)"},
  ...
  {"START", "FINAL", "(not op.objects_on_table) and (not HERB_holding_object)"},
  ...
  {"SORT_LEFT", "PLACE_ON_TABLE_LEFT", "left_held_object_unsortable"},
  ...
  {"SORT_RIGHT", "PLACE_ON_TABLE_RIGHT", "right_held_object_unsortable"},
