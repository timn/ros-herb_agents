...
fsm:define_states{ export_to=_M,
  ...
  {"PICKUP_RIGHT", Skill, skills={{"pickup", side="right", exec_timelimit=EXEC_TIME_LIMIT}},
  ...
  {"PLACE_LEFT",Skill, skills={{"place", side="left", object_id=TABLETOP_NAME_LEFT, exec_timelimit=EXEC_TIME_LIMIT}}, 
          ...
          failure_state="FAILED", hide_failure_transition = true},
  {"SORT_PLACE_INTO_BIN",Skill, skills={{"say", text="This <break time='100ms'/> goes in <prosody rate='x-slow'> my </prosody> bin."},{"put", side="left", object_id=ROBOT_BIN_NAME, exec_timelimit=EXEC_TIME_LIMIT}}, 
          final_state="SWITCH_HANDS",
          failure_state="FAILED", hide_failure_transition = true},
  {"SWITCH_HANDS",Skill, skills={{"handover", side="right", exec_timelimit=EXEC_TIME_LIMIT}}, 
          final_state="GO_INITIAL_RIGHT",
          failure_state="FAILED", hide_failure_transition = true},
  {"GO_INITIAL_RIGHT",Skill, skills={{"goinitial",side="right", exec_timelimit=EXEC_TIME_LIMIT}}, 
          final_state="PLACE_INTO_BIN",
          failure_state="PLACE_INTO_BIN"},
  {"PLACE_INTO_BIN",Skill, skills={{"say", text="This goes in my bin."},{"put", side="left", object_id=ROBOT_BIN_NAME, exec_timelimit=EXEC_TIME_LIMIT}}, 
          final_state="GO_INITIAL_LEFT",
          failure_state="FAILED", hide_failure_transition = true},
  {"GO_INITIAL_LEFT",Skill, skills={{"goinitial",side="left", exec_timelimit=EXEC_TIME_LIMIT}},
          final_state="FINAL",
          failure_state="FINAL"},
  {"FINAL", JumpState},
  {"TAKE_FAIL_GO_INITIAL_RIGHT",Skill, skills={{"goinitial",side="right", exec_timelimit=EXEC_TIME_LIMIT}}, 
          final_state="FAILED",
          failure_state="FAILED", hide_failure_transition = true},
  {"FAILED", JumpState},
}
...
fsm:add_transitions{
  ...
  {"CHECK_LEFT_HAND", "SORT_LEFT", "op.HERB_holding_object_in_left_hand"},
  {"SORT_LEFT", "PLACE_LEFT", "(not op.left_held_object_belongs_in_robot_bin)"},
