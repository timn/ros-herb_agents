...
depends_skills     = {"say", "point_to", "reset_arms"}
depends_topics     = {
...
fsm:define_states{ export_to=_M,
   ...
   {"GREET",       Skill, skills={{"say", text=TEXT_GREET}},           final_to="PTO_ARM",     fail_to="RECOVER"},
   {"PTO_ARM",     Skill, skills={{"point_to", position="arm"}},       final_to="EXP_ARM",     fail_to="RECOVER"},
   {"EXP_ARM",     Skill, skills={{"say", text=TEXT_ARM}},             final_to="PTO_HAND",    fail_to="RECOVER"},
   {"PTO_HAND",    Skill, skills={{"point_to", position="hand"}},      final_to="EXP_HAND",    fail_to="RECOVER"},
   {"EXP_HAND",    Skill, skills={{"say", text=TEXT_HAND}},            final_to="PTO_3DLASER", fail_to="RECOVER"},
   {"PTO_3DLASER", Skill, skills={{"point_to", position="3dlaser"}},   final_to="EXP_3DLASER", fail_to="RECOVER"},
   {"EXP_3DLASER", Skill, skills={{"say", text=TEXT_3DLASER}},         final_to="PTO_PROSIL",  fail_to="RECOVER"},
   {"PTO_PROSIL",  Skill, skills={{"point_to", position="prosilica"}}, final_to="EXP_PROSIL",  fail_to="RECOVER"},
   {"EXP_PROSIL",  Skill, skills={{"say", text=TEXT_PROSILICA}},       final_to="PTO_OBLASER", fail_to="RECOVER"},
   {"PTO_OBLASER", Skill, skills={{"point_to", position="oblaser"}},   final_to="EXP_OBLASER", fail_to="RECOVER"},
   {"EXP_OBLASER", Skill, skills={{"say", text=TEXT_OBLASER}},         final_to="PTO_GUTS",    fail_to="RECOVER"},
   {"PTO_GUTS",    Skill, skills={{"point_to", position="laptops"}},   final_to="EXP_GUTS",    fail_to="RECOVER"},
   {"EXP_GUTS",    Skill, skills={{"say", text=TEXT_GUTS}},            final_to="PTO_SEGWAY" , fail_to="RECOVER"},
   {"PTO_SEGWAY",  Skill, skills={{"point_to", position="segway"}},    final_to="EXP_SEGWAY",  fail_to="RECOVER"},
